...
class AdminUsersViews(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            return Response(
                AdminUsersSerializer(user).data, status=status.HTTP_201_CREATED
            )
    ...
    def put(self, request, pk=None):
        ...
        serializer = AdminUsersSerializer(user, data=request.data)
        if serializer.is_valid():
            data = serializer.validated_data
            ...
            return Response(AdminUsersSerializer(updated_user).data)
    ...
    def patch(self, request, pk=None):
        ...
        serializer = AdminUsersSerializer(user, data=request.data, partial=True)
        if serializer.is_valid():
            data = serializer.validated_data
