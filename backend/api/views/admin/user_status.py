...
class AdminUserStatusViews(APIView):
    ...
    def get(self, request, pk=None):
        if pk:
            ...
            serializer = AdminUserStatusSerializer(user_status)
            return Response(serializer.data)

        user_statuses = self.accessor.get_all()
        serializer = AdminUserStatusSerializer(user_statuses, many=True)
        return Response(serializer.data)
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            return Response(
                AdminUserStatusSerializer(user_status).data,
    ...
    def put(self, request, pk=None):
        ...
        serializer = AdminUserStatusSerializer(user_status, data=request.data)
        if serializer.is_valid():
            data = serializer.validated_data
            updated_status = self.accessor.update(pk, **data)
            return Response(AdminUserStatusSerializer(updated_status).data)
