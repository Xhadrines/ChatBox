...
class HomeView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["endpoints"] = [
            ("User Roles", "/api-orm/cf/user-roles/"),
            ("User Status", "/api-orm/cf/user-status/"),
            ("Users", "/api-orm/cf/users/"),
            ("Plan Types", "/api-orm/cf/plan-types/"),
            ("Plans", "/api-orm/cf/plans/"),
            ("User Plans", "/api-orm/cf/user-plans/"),
            ("Files", "/api-orm/cf/files/"),
            ("Messages", "/api-orm/cf/messages/"),
            ("User Usage", "/api-orm/cf/user-usage/"),
        ]
